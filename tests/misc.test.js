...
describe('1000 ms should be converted to 00:00:01.00', () => {
    test('milli 1', () => {
        expect(millisecondsToString(1000)).toBe('00:00:01.00');
    });
});

describe('0 ms should be converted to 00:00:00.00', () => {
    test('milli 2', () => {
        expect(millisecondsToString(0)).toBe('00:00:00.00');
    });
});
